...
### From GitHub
```bash
pip install "x-twitter-mcp[articles] @ git+https://github.com/vibeforge1111/vibeship-spark-intelligence.git#subdirectory=mcp-servers/x-twitter-mcp"
```

### From Source
```bash
git clone https://github.com/vibeforge1111/vibeship-spark-intelligence.git
cd vibeship-spark-intelligence/mcp-servers/x-twitter-mcp
