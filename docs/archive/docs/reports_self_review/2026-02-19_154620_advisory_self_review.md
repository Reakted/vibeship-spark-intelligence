# Advisory Self-Review (2026-02-19T15:46:20.493871+00:00)
...
## Core Metrics
- Advisory rows: 590
- Advisory trace coverage: 558/590 (94.58%)
- Advice items emitted: 599
- Non-benchmark advisory rows: 590 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.127
...
- `spark-auto-s7-read-1771515909922` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515909831` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515909387` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515909286` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515909184` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515909061` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515906012` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~57.12% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 57x (9.52%) Use packet guidance.
- 57x (9.52%) Live guidance.
- 57x (9.52%) Live guidance with policy.
- 57x (9.52%) Fallback from emitted advice text.
- 57x (9.52%) Trace-linked live guidance.
- 57x (9.52%) Warning-level guidance.
