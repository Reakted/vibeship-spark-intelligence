# Advisory Self-Review (2026-02-19T15:30:31.272898+00:00)
...
## Core Metrics
- Advisory rows: 364
- Advisory trace coverage: 332/364 (91.21%)
- Advice items emitted: 373
- Non-benchmark advisory rows: 364 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.2065
...
- `spark-auto-s7-read-1771515022680` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515022594` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515022228` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515022130` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515022046` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515021944` | tool `Edit` | source `packet` | Use packet guidance.
- `38004a041d0bb00f` | tool `Grep` | source `prefetch` | Use Read conservatively with fast validation and explicit rollback safety.
...
- Yes. Top repeated advisories account for ~41.82% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 26x (6.97%) Use packet guidance.
- 26x (6.97%) Live guidance.
- 26x (6.97%) Live guidance with policy.
- 26x (6.97%) Fallback from emitted advice text.
- 26x (6.97%) Trace-linked live guidance.
- 26x (6.97%) Warning-level guidance.
