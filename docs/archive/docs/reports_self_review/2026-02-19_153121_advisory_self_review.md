# Advisory Self-Review (2026-02-19T15:31:21.798417+00:00)
...
## Core Metrics
- Advisory rows: 371
- Advisory trace coverage: 339/371 (91.37%)
- Advice items emitted: 380
- Non-benchmark advisory rows: 371 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1935
...
- `spark-auto-s7-read-1771515041495` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515041419` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515041014` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515040921` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515040826` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515040712` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~42.66% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 27x (7.11%) Use packet guidance.
- 27x (7.11%) Live guidance.
- 27x (7.11%) Live guidance with policy.
- 27x (7.11%) Fallback from emitted advice text.
- 27x (7.11%) Trace-linked live guidance.
- 27x (7.11%) Warning-level guidance.
