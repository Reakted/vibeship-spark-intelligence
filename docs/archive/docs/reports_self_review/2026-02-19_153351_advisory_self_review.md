# Advisory Self-Review (2026-02-19T15:33:51.052216+00:00)
...
## Core Metrics
- Advisory rows: 409
- Advisory trace coverage: 377/409 (92.18%)
- Advice items emitted: 418
- Non-benchmark advisory rows: 409 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1753
...
- `spark-auto-s7-read-1771515197580` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515197439` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515196848` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515196714` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515196572` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515196385` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515186724` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~45.96% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 32x (7.66%) Use packet guidance.
- 32x (7.66%) Live guidance.
- 32x (7.66%) Live guidance with policy.
- 32x (7.66%) Fallback from emitted advice text.
- 32x (7.66%) Trace-linked live guidance.
- 32x (7.66%) Warning-level guidance.
