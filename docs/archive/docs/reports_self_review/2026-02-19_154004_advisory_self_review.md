# Advisory Self-Review (2026-02-19T15:40:04.844417+00:00)
...
## Core Metrics
- Advisory rows: 516
- Advisory trace coverage: 484/516 (93.8%)
- Advice items emitted: 525
- Non-benchmark advisory rows: 516 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1404
...
- `spark-auto-s7-read-1771515579018` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515578700` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515578191` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515578082` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515577963` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515577829` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~53.7% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 47x (8.95%) Use packet guidance.
- 47x (8.95%) Live guidance.
- 47x (8.95%) Live guidance with policy.
- 47x (8.95%) Fallback from emitted advice text.
- 47x (8.95%) Trace-linked live guidance.
- 47x (8.95%) Warning-level guidance.
