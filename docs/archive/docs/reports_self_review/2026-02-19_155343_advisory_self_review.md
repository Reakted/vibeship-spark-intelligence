# Advisory Self-Review (2026-02-19T15:53:43.666919+00:00)
...
## Core Metrics
- Advisory rows: 664
- Advisory trace coverage: 632/664 (95.18%)
- Advice items emitted: 673
- Non-benchmark advisory rows: 664 (excluded 0)
- Engine events: 500
...
- `spark-auto-s7-read-1771516345677` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771516345557` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771516345055` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771516344946` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771516344841` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771516344705` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771516338040` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~59.76% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 67x (9.96%) Use packet guidance.
- 67x (9.96%) Live guidance.
- 67x (9.96%) Live guidance with policy.
- 67x (9.96%) Fallback from emitted advice text.
- 67x (9.96%) Trace-linked live guidance.
- 67x (9.96%) Warning-level guidance.
