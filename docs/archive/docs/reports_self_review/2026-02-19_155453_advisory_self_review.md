# Advisory Self-Review (2026-02-19T15:54:53.806332+00:00)
...
## Core Metrics
- Advisory rows: 680
- Advisory trace coverage: 648/680 (95.29%)
- Advice items emitted: 689
- Non-benchmark advisory rows: 680 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1087
...
- `388f2927492dfa54` | tool `Write` | source `cognitive` | When using Bash, remember: Do that after pushing this git up.
- `spark-auto-s7-read-1771516435552` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771516435439` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771516434994` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771516434873` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771516434745` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771516434569` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~60.06% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 69x (10.01%) Use packet guidance.
- 69x (10.01%) Live guidance.
- 69x (10.01%) Live guidance with policy.
- 69x (10.01%) Fallback from emitted advice text.
- 69x (10.01%) Trace-linked live guidance.
- 69x (10.01%) Warning-level guidance.
