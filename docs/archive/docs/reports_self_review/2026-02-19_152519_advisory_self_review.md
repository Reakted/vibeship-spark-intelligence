# Advisory Self-Review (2026-02-19T15:25:19.169793+00:00)
...
## Core Metrics
- Advisory rows: 283
- Advisory trace coverage: 251/283 (88.69%)
- Advice items emitted: 292
- Non-benchmark advisory rows: 283 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1899
...
- `spark-auto-s7-read-1771514688076` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771514687952` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771514686668` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771514686516` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771514686396` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771514686137` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~30.84% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 15x (5.14%) Use packet guidance.
- 15x (5.14%) Live guidance.
- 15x (5.14%) Live guidance with policy.
- 15x (5.14%) Fallback from emitted advice text.
- 15x (5.14%) Trace-linked live guidance.
- 15x (5.14%) Warning-level guidance.
