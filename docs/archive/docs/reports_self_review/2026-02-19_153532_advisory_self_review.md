# Advisory Self-Review (2026-02-19T15:35:32.731674+00:00)
...
## Core Metrics
- Advisory rows: 438
- Advisory trace coverage: 406/438 (92.69%)
- Advice items emitted: 447
- Non-benchmark advisory rows: 438 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1748
- Strict effectiveness rate: 0.7222
...
- `spark-auto-s7-read-1771515323678` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515323578` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515322612` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515322496` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515322385` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515322255` | tool `Edit` | source `packet` | Use packet guidance.
- `7b7b87b0aa47878b` | tool `Grep` | source `baseline` | Use conservative, test-backed edits and verify assumptions before irreversible actions. Next check: `python -m pytest -q`.
...
- Yes. Top repeated advisories account for ~48.3% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 36x (8.05%) Use packet guidance.
- 36x (8.05%) Live guidance.
- 36x (8.05%) Live guidance with policy.
- 36x (8.05%) Fallback from emitted advice text.
- 36x (8.05%) Trace-linked live guidance.
- 36x (8.05%) Warning-level guidance.
