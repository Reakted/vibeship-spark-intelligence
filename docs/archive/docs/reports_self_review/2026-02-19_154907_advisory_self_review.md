# Advisory Self-Review (2026-02-19T15:49:07.932923+00:00)
...
## Core Metrics
- Advisory rows: 618
- Advisory trace coverage: 586/618 (94.82%)
- Advice items emitted: 627
- Non-benchmark advisory rows: 618 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1154
...
- `spark-auto-s7-read-1771516074251` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771516074111` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771516073583` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771516073436` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771516073299` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771516073131` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771516071242` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~58.38% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 61x (9.73%) Use packet guidance.
- 61x (9.73%) Live guidance.
- 61x (9.73%) Live guidance with policy.
- 61x (9.73%) Fallback from emitted advice text.
- 61x (9.73%) Trace-linked live guidance.
- 61x (9.73%) Warning-level guidance.
