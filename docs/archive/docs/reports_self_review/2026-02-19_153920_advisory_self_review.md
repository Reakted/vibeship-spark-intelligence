# Advisory Self-Review (2026-02-19T15:39:20.203590+00:00)
...
## Core Metrics
- Advisory rows: 501
- Advisory trace coverage: 469/501 (93.61%)
- Advice items emitted: 510
- Non-benchmark advisory rows: 501 (excluded 0)
- Engine events: 500
...
- `spark-auto-s7-read-1771515540789` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515540668` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515540247` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515540131` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515540016` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515539872` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~52.92% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 45x (8.82%) Use packet guidance.
- 45x (8.82%) Live guidance.
- 45x (8.82%) Live guidance with policy.
- 45x (8.82%) Fallback from emitted advice text.
- 45x (8.82%) Trace-linked live guidance.
- 45x (8.82%) Warning-level guidance.
