# Advisory Self-Review (2026-02-19T15:31:43.389192+00:00)
...
## Core Metrics
- Advisory rows: 378
- Advisory trace coverage: 346/378 (91.53%)
- Advice items emitted: 387
- Non-benchmark advisory rows: 378 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1915
...
- `spark-auto-s7-read-1771515093988` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515093879` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515093241` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515092902` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515092696` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515092534` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~43.44% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 28x (7.24%) Use packet guidance.
- 28x (7.24%) Live guidance.
- 28x (7.24%) Live guidance with policy.
- 28x (7.24%) Fallback from emitted advice text.
- 28x (7.24%) Trace-linked live guidance.
- 28x (7.24%) Warning-level guidance.
