# Advisory Self-Review (2026-02-19T15:36:56.580838+00:00)
...
## Core Metrics
- Advisory rows: 459
- Advisory trace coverage: 427/459 (93.03%)
- Advice items emitted: 468
- Non-benchmark advisory rows: 459 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1604
...
- `spark-auto-s7-read-1771515396376` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515396280` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515395859` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515395741` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515395632` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515395486` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~49.98% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 39x (8.33%) Use packet guidance.
- 39x (8.33%) Live guidance.
- 39x (8.33%) Live guidance with policy.
- 39x (8.33%) Fallback from emitted advice text.
- 39x (8.33%) Trace-linked live guidance.
- 39x (8.33%) Warning-level guidance.
