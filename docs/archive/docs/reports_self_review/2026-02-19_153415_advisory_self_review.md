# Advisory Self-Review (2026-02-19T15:34:15.012482+00:00)
...
## Core Metrics
- Advisory rows: 416
- Advisory trace coverage: 384/416 (92.31%)
- Advice items emitted: 425
- Non-benchmark advisory rows: 416 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1919
...
- Yes. Top repeated advisories account for ~46.56% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 33x (7.76%) Use packet guidance.
- 33x (7.76%) Live guidance.
- 33x (7.76%) Live guidance with policy.
- 33x (7.76%) Fallback from emitted advice text.
- 33x (7.76%) Trace-linked live guidance.
- 33x (7.76%) Warning-level guidance.
