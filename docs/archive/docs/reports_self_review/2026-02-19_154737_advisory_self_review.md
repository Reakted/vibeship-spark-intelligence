# Advisory Self-Review (2026-02-19T15:47:37.725247+00:00)
...
## Core Metrics
- Advisory rows: 604
- Advisory trace coverage: 572/604 (94.7%)
- Advice items emitted: 613
- Non-benchmark advisory rows: 604 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.125
- Strict effectiveness rate: 0.625
- Trace mismatch count: 54
...
- `spark-auto-s7-read-1771515991050` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515990959` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515990488` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515990392` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515990289` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515990165` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515987528` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~57.72% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 59x (9.62%) Use packet guidance.
- 59x (9.62%) Live guidance.
- 59x (9.62%) Live guidance with policy.
- 59x (9.62%) Fallback from emitted advice text.
- 59x (9.62%) Trace-linked live guidance.
- 59x (9.62%) Warning-level guidance.
...
- trace `e3e658ecb07f7b0d` | source `prefetch` | insight `prefetch:research_decision_support:Bash` | Use Bash conservatively with fast validation and explicit rollback safety.
