# Advisory Self-Review (2026-02-19T15:57:26.800650+00:00)
...
## Core Metrics
- Advisory rows: 710
- Advisory trace coverage: 678/710 (95.49%)
- Advice items emitted: 719
- Non-benchmark advisory rows: 710 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1064
...
- `spark-auto-s7-read-1771516587316` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s7-read-1771516587285` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771516587156` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771516586582` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2d-read-1771516586595` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771516586428` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2b-read-1771516586439` | tool `Read` | source `advisor` | Live guidance with policy.
...
- Yes. Top repeated advisories account for ~60.9% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 73x (10.15%) Use packet guidance.
- 73x (10.15%) Live guidance.
- 73x (10.15%) Live guidance with policy.
- 73x (10.15%) Fallback from emitted advice text.
- 73x (10.15%) Trace-linked live guidance.
- 73x (10.15%) Warning-level guidance.
