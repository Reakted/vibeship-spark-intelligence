# Advisory Self-Review (2026-02-19T15:43:30.324882+00:00)
...
## Core Metrics
- Advisory rows: 560
- Advisory trace coverage: 528/560 (94.29%)
- Advice items emitted: 569
- Non-benchmark advisory rows: 560 (excluded 0)
- Engine events: 500
...
- `spark-auto-s7-read-1771515750301` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515750226` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515749862` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515749762` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515749634` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515749461` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515743160` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~55.86% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 53x (9.31%) Use packet guidance.
- 53x (9.31%) Live guidance.
- 53x (9.31%) Live guidance with policy.
- 53x (9.31%) Fallback from emitted advice text.
- 53x (9.31%) Trace-linked live guidance.
- 53x (9.31%) Warning-level guidance.
