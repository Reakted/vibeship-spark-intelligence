# Advisory Self-Review (2026-02-19T15:36:24.083074+00:00)
...
## Core Metrics
- Advisory rows: 452
- Advisory trace coverage: 420/452 (92.92%)
- Advice items emitted: 461
- Non-benchmark advisory rows: 452 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1714
- Strict effectiveness rate: 0.7222
- Trace mismatch count: 50
...
- `spark-auto-s7-read-1771515352536` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515352453` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515352013` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515351921` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515351826` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515351712` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515343496` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~49.44% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 38x (8.24%) Use packet guidance.
- 38x (8.24%) Live guidance.
- 38x (8.24%) Live guidance with policy.
- 38x (8.24%) Fallback from emitted advice text.
- 38x (8.24%) Trace-linked live guidance.
- 38x (8.24%) Warning-level guidance.
