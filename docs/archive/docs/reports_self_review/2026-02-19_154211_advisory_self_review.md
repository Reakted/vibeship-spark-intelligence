# Advisory Self-Review (2026-02-19T15:42:11.475599+00:00)
...
## Core Metrics
- Advisory rows: 546
- Advisory trace coverage: 514/546 (94.14%)
- Advice items emitted: 555
- Non-benchmark advisory rows: 546 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1345
- Strict effectiveness rate: 0.6875
- Trace mismatch count: 53
...
- `spark-auto-s7-read-1771515700068` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515699955` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515698954` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515698838` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515698719` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515698581` | tool `Edit` | source `packet` | Use packet guidance.
- `3ddccc18af1a1d15` | tool `Bash` | source `trigger` | Validate authentication inputs server-side and avoid trusting client checks.
...
- Yes. Top repeated advisories account for ~55.14% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 51x (9.19%) Use packet guidance.
- 51x (9.19%) Live guidance.
- 51x (9.19%) Live guidance with policy.
- 51x (9.19%) Fallback from emitted advice text.
- 51x (9.19%) Trace-linked live guidance.
- 51x (9.19%) Warning-level guidance.
