# Advisory Self-Review (2026-02-19T15:24:23.476375+00:00)
...
## Core Metrics
- Advisory rows: 269
- Advisory trace coverage: 237/269 (88.1%)
- Advice items emitted: 278
- Non-benchmark advisory rows: 269 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1974
...
- `spark-auto-s6-edit-1771514649346` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771514648856` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771514648657` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771514648533` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771514648332` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~28.08% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 13x (4.68%) Use packet guidance.
- 13x (4.68%) Live guidance.
- 13x (4.68%) Live guidance with policy.
- 13x (4.68%) Fallback from emitted advice text.
- 13x (4.68%) Trace-linked live guidance.
- 13x (4.68%) Warning-level guidance.
