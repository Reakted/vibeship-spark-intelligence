# Advisory Self-Review (2026-02-19T15:28:04.823722+00:00)
...
## Core Metrics
- Advisory rows: 319
- Advisory trace coverage: 287/319 (89.97%)
- Advice items emitted: 328
- Non-benchmark advisory rows: 319 (excluded 0)
- Engine events: 501
- Engine trace coverage: 501/501 (100.0%)
...
- `spark-auto-s7-read-1771514850136` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771514850026` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771514849451` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771514849282` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771514849155` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771514848956` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771514824692` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~36.6% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 20x (6.1%) Use packet guidance.
- 20x (6.1%) Live guidance.
- 20x (6.1%) Live guidance with policy.
- 20x (6.1%) Fallback from emitted advice text.
- 20x (6.1%) Trace-linked live guidance.
- 20x (6.1%) Warning-level guidance.
