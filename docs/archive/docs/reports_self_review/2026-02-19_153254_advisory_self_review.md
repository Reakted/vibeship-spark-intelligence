# Advisory Self-Review (2026-02-19T15:32:54.038552+00:00)
...
## Core Metrics
- Advisory rows: 393
- Advisory trace coverage: 361/393 (91.86%)
- Advice items emitted: 402
- Non-benchmark advisory rows: 393 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1875
...
- `spark-auto-s7-read-1771515166112` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515165992` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515165437` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515165313` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515164924` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515164160` | tool `Edit` | source `packet` | Use packet guidance.
- `a9d4a31b67a769d2` | tool `Write` | source `prefetch` | Use Bash conservatively with fast validation and explicit rollback safety.
...
- Yes. Top repeated advisories account for ~44.76% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 30x (7.46%) Use packet guidance.
- 30x (7.46%) Live guidance.
- 30x (7.46%) Live guidance with policy.
- 30x (7.46%) Fallback from emitted advice text.
- 30x (7.46%) Trace-linked live guidance.
- 30x (7.46%) Warning-level guidance.
