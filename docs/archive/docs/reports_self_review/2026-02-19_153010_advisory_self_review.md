# Advisory Self-Review (2026-02-19T15:30:10.516026+00:00)
...
## Core Metrics
- Advisory rows: 357
- Advisory trace coverage: 325/357 (91.04%)
- Advice items emitted: 366
- Non-benchmark advisory rows: 357 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.2198
...
- `spark-auto-s7-read-1771514971593` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771514971506` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771514971075` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771514970983` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771514970893` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771514970783` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~40.98% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 25x (6.83%) Use packet guidance.
- 25x (6.83%) Live guidance.
- 25x (6.83%) Live guidance with policy.
- 25x (6.83%) Fallback from emitted advice text.
- 25x (6.83%) Trace-linked live guidance.
- 25x (6.83%) Warning-level guidance.
