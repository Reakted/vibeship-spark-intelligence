# Advisory Self-Review (2026-02-19T15:44:59.077800+00:00)
...
## Core Metrics
- Advisory rows: 575
- Advisory trace coverage: 543/575 (94.43%)
- Advice items emitted: 584
- Non-benchmark advisory rows: 575 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1301
...
- `7d68807ee7ebab8c` | tool `TaskCreate` | source `cognitive` | When using Bash, remember: Do that after pushing this git up.
- `spark-auto-s7-read-1771515826736` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515826649` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515826197` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515826081` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515825976` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515825849` | tool `Edit` | source `packet` | Use packet guidance.
...
- 55x (9.42%) Use packet guidance.
- 55x (9.42%) Live guidance.
- 55x (9.42%) Live guidance with policy.
- 55x (9.42%) Fallback from emitted advice text.
- 55x (9.42%) Trace-linked live guidance.
- 55x (9.42%) Warning-level guidance.
