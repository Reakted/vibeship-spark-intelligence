# Advisory Self-Review (2026-02-19T15:50:40.191519+00:00)
...
## Core Metrics
- Advisory rows: 633
- Advisory trace coverage: 601/633 (94.94%)
- Advice items emitted: 642
- Non-benchmark advisory rows: 633 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1061
- Strict effectiveness rate: 0.6429
- Trace mismatch count: 56
...
- `d5c1c98f7a9b323a` | tool `Edit` | source `prefetch` | Use Edit conservatively with fast validation and explicit rollback safety.
- `spark-auto-s7-read-1771516162287` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771516162123` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771516161530` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771516161363` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771516161201` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771516161008` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~58.86% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 63x (9.81%) Use packet guidance.
- 63x (9.81%) Live guidance.
- 63x (9.81%) Live guidance with policy.
- 63x (9.81%) Fallback from emitted advice text.
- 63x (9.81%) Trace-linked live guidance.
- 63x (9.81%) Warning-level guidance.
