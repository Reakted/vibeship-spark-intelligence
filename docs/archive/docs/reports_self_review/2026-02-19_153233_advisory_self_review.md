# Advisory Self-Review (2026-02-19T15:32:33.162965+00:00)
...
## Core Metrics
- Advisory rows: 385
- Advisory trace coverage: 353/385 (91.69%)
- Advice items emitted: 394
- Non-benchmark advisory rows: 385 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1809
...
- `spark-auto-s7-read-1771515113589` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515113510` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515113060` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515112966` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515112872` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515112765` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~44.16% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 29x (7.36%) Use packet guidance.
- 29x (7.36%) Live guidance.
- 29x (7.36%) Live guidance with policy.
- 29x (7.36%) Fallback from emitted advice text.
- 29x (7.36%) Trace-linked live guidance.
- 29x (7.36%) Warning-level guidance.
