# Advisory Self-Review (2026-02-19T15:38:48.666567+00:00)
...
## Core Metrics
- Advisory rows: 494
- Advisory trace coverage: 462/494 (93.52%)
- Advice items emitted: 503
- Non-benchmark advisory rows: 494 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1532
...
- `spark-auto-s7-read-1771515500531` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515500450` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515500011` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515499912` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515499816` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515499697` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515493769` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~52.5% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 44x (8.75%) Use packet guidance.
- 44x (8.75%) Live guidance.
- 44x (8.75%) Live guidance with policy.
- 44x (8.75%) Fallback from emitted advice text.
- 44x (8.75%) Trace-linked live guidance.
- 44x (8.75%) Warning-level guidance.
