# Advisory Self-Review (2026-02-19T15:24:36.513276+00:00)
...
## Core Metrics
- Advisory rows: 276
- Advisory trace coverage: 244/276 (88.41%)
- Advice items emitted: 285
- Non-benchmark advisory rows: 276 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1842
...
- `spark-auto-s7-read-1771514673221` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771514673071` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771514672524` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771514672370` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771514672217` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771514672028` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771514649522` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~29.46% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 14x (4.91%) Use packet guidance.
- 14x (4.91%) Live guidance.
- 14x (4.91%) Live guidance with policy.
- 14x (4.91%) Fallback from emitted advice text.
- 14x (4.91%) Trace-linked live guidance.
- 14x (4.91%) Warning-level guidance.
