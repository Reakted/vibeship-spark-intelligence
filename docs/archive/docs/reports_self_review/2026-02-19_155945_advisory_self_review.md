# Advisory Self-Review (2026-02-19T15:59:45.573120+00:00)
...
## Core Metrics
- Advisory rows: 732
- Advisory trace coverage: 700/732 (95.63%)
- Advice items emitted: 741
- Non-benchmark advisory rows: 732 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.0972
...
- `spark-auto-s7-read-1771516731969` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771516731884` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771516731407` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771516731309` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771516731212` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771516731089` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~61.56% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 76x (10.26%) Use packet guidance.
- 76x (10.26%) Live guidance.
- 76x (10.26%) Live guidance with policy.
- 76x (10.26%) Fallback from emitted advice text.
- 76x (10.26%) Trace-linked live guidance.
- 76x (10.26%) Warning-level guidance.
