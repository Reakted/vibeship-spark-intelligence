# Advisory Self-Review (2026-02-19T15:37:36.272114+00:00)
...
## Core Metrics
- Advisory rows: 473
- Advisory trace coverage: 441/473 (93.23%)
- Advice items emitted: 482
- Non-benchmark advisory rows: 473 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1495
...
- `spark-auto-s6-edit-1771515426585` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515426130` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515426040` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515425930` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515425795` | tool `Edit` | source `packet` | Use packet guidance.
- `spark-auto-s7-read-1771515418852` | tool `Read` | source `advisor` | Note-level guidance.
...
- Yes. Top repeated advisories account for ~51.06% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 41x (8.51%) Use packet guidance.
- 41x (8.51%) Live guidance.
- 41x (8.51%) Live guidance with policy.
- 41x (8.51%) Fallback from emitted advice text.
- 41x (8.51%) Trace-linked live guidance.
- 41x (8.51%) Warning-level guidance.
