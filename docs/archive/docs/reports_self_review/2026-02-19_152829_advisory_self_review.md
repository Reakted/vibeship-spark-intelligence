# Advisory Self-Review (2026-02-19T15:28:29.833030+00:00)
...
## Core Metrics
- Advisory rows: 327
- Advisory trace coverage: 295/327 (90.21%)
- Advice items emitted: 336
- Non-benchmark advisory rows: 327 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.2209
...
- `bec9a3cd0f90a531` | tool `Write` | source `prefetch` | Use Edit conservatively with fast validation and explicit rollback safety.
- `spark-auto-s7-read-1771514897333` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771514897214` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771514896594` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771514896285` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771514896084` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771514895927` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~37.5% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 21x (6.25%) Use packet guidance.
- 21x (6.25%) Live guidance.
- 21x (6.25%) Live guidance with policy.
- 21x (6.25%) Fallback from emitted advice text.
- 21x (6.25%) Trace-linked live guidance.
- 21x (6.25%) Warning-level guidance.
