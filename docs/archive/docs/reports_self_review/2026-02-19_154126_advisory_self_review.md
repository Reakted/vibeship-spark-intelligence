# Advisory Self-Review (2026-02-19T15:41:26.778012+00:00)
...
## Core Metrics
- Advisory rows: 539
- Advisory trace coverage: 507/539 (94.06%)
- Advice items emitted: 548
- Non-benchmark advisory rows: 539 (excluded 0)
- Engine events: 500
- Engine trace coverage: 500/500 (100.0%)
- Fallback share (delivered): 0.0%
- Strict action rate: 0.1282
...
- `spark-auto-s7-read-1771515664222` | tool `Read` | source `advisor` | Note-level guidance.
- `spark-auto-s6-edit-1771515664092` | tool `Edit` | source `advisor` | Warning-level guidance.
- `trace-auto-1` | tool `Read` | source `advisor` | Trace-linked live guidance.
- `spark-auto-s2d-read-1771515663079` | tool `Read` | source `cognitive` | Fallback from emitted advice text.
- `spark-auto-s2b-read-1771515662967` | tool `Read` | source `advisor` | Live guidance with policy.
- `spark-auto-s2-read-1771515662857` | tool `Read` | source `advisor` | Live guidance.
- `spark-auto-s1-edit-1771515662698` | tool `Edit` | source `packet` | Use packet guidance.
...
- Yes. Top repeated advisories account for ~54.72% of all advice items in this window.

## Top Repeated Advice (Noise Candidates)
- 50x (9.12%) Use packet guidance.
- 50x (9.12%) Live guidance.
- 50x (9.12%) Live guidance with policy.
- 50x (9.12%) Fallback from emitted advice text.
- 50x (9.12%) Trace-linked live guidance.
- 50x (9.12%) Warning-level guidance.
