...
Generated: `2026-02-15T15:02:48Z`
...
- branch: `main`
- describe: `a9843de-dirty`
- dirty: `True` (1)

## Findings

- **FAIL** `REVIEW_ATTESTATION_MISSING` - Review attestation missing for change_id=chg-20260215-150244-step3-latency-tail-deny-agentic-esca.
...
```json
{
  ...
  "generated_at": "2026-02-15T15:02:48Z",
  ...
  "git": {
    ...
    "branch": "main",
    "commit": "a9843de96108315965b2e634f7c104738478104f",
    "describe": "a9843de-dirty",
    "dirty": true,
    "dirty_count": 1,
  ...
  "findings": [
    {
      ...
      "message": "Review attestation missing for change_id=chg-20260215-150244-step3-latency-tail-deny-agentic-esca.",
      "hint": "Run: vibeship-optimizer review bundle ... then vibeship-optimizer review attest --tool codex --reasoning-mode xhigh ..."
    },
    {
      "level": "warn",
  ...
  "analysis": {
    ...
    "generated_at": "2026-02-15T15:02:45Z",
    "project_root": "C:\\Users\\USER\\Desktop\\vibeship-spark-intelligence",
    "languages_detected": [
      "node",
      "python"
