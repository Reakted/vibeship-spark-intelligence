...
Generated: `2026-02-15T14:32:25Z`
...
- branch: `main`
- describe: `98b8ecd-dirty`
- dirty: `True` (3)

## Findings

- **FAIL** `REVIEW_ATTESTATION_MISSING` - Review attestation missing for change_id=chg-20260215-142935-step1-advisory-speed-default-force_p.
  - hint: Run: vibeship-optimizer review bundle ... then vibeship-optimizer review attest --tool codex --reasoning-mode xhigh ...
- **WARN** `GIT_DIRTY` - Working tree is dirty (3 changed files).
...
```json
{
  ...
  "generated_at": "2026-02-15T14:32:25Z",
  ...
  "git": {
    ...
    "branch": "main",
    "commit": "98b8ecde9d14d6cac58e2f670618b0792b56ed46",
    "describe": "98b8ecd-dirty",
    "dirty": true,
    "dirty_count": 3,
    "diff_stat": "VIBESHIP_OPTIMIZER.md               | 93 +++++++++++++++++++++++++++++++++++++\n scripts/vibeship_optimizer_loop.ps1 | 31 +++++++++----\n 2 files changed, 116 insertions(+), 8 deletions(-)"
  },
  ...
  "findings": [
    {
      ...
      "message": "Review attestation missing for change_id=chg-20260215-142935-step1-advisory-speed-default-force_p.",
      "hint": "Run: vibeship-optimizer review bundle ... then vibeship-optimizer review attest --tool codex --reasoning-mode xhigh ..."
    },
    {
      "level": "warn",
      "code": "GIT_DIRTY",
      "message": "Working tree is dirty (3 changed files).",
      "hint": "Commit or stash before snapshotting so before/after is attributable."
    },
    {
      "level": "info",
  ...
  "analysis": {
    ...
    "generated_at": "2026-02-15T14:32:22Z",
    "project_root": "C:\\Users\\USER\\Desktop\\vibeship-spark-intelligence",
    "languages_detected": [
      "node",
      "python"
