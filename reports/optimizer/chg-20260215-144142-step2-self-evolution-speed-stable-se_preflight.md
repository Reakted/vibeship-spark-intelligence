...
Generated: `2026-02-15T14:41:46Z`
...
- branch: `main`
- describe: `8c57587-dirty`
- dirty: `True` (1)

## Findings

- **FAIL** `REVIEW_ATTESTATION_MISSING` - Review attestation missing for change_id=chg-20260215-144142-step2-self-evolution-speed-stable-se.
  - hint: Run: vibeship-optimizer review bundle ... then vibeship-optimizer review attest --tool codex --reasoning-mode xhigh ...
- **WARN** `GIT_DIRTY` - Working tree is dirty (1 changed files).
...
```json
{
  ...
  "generated_at": "2026-02-15T14:41:46Z",
  ...
  "git": {
    ...
    "branch": "main",
    "commit": "8c57587531bf875bdf9df6f8bea229fcb4b9b096",
    "describe": "8c57587-dirty",
    "dirty": true,
    "dirty_count": 1,
    "diff_stat": "VIBESHIP_OPTIMIZER.md | 31 +++++++++++++++++++++++++++++++\n 1 file changed, 31 insertions(+)"
  },
  ...
  "findings": [
    {
      ...
      "message": "Review attestation missing for change_id=chg-20260215-144142-step2-self-evolution-speed-stable-se.",
      "hint": "Run: vibeship-optimizer review bundle ... then vibeship-optimizer review attest --tool codex --reasoning-mode xhigh ..."
    },
    {
      "level": "warn",
      "code": "GIT_DIRTY",
      "message": "Working tree is dirty (1 changed files).",
      "hint": "Commit or stash before snapshotting so before/after is attributable."
    },
    {
      "level": "info",
  ...
  "analysis": {
    ...
    "generated_at": "2026-02-15T14:41:43Z",
    "project_root": "C:\\Users\\USER\\Desktop\\vibeship-spark-intelligence",
    "languages_detected": [
      "node",
      "python"
